...
func createProcesses(
    ...
    case nested.UploadTypePlacePicture, nested.UploadTypeProfilePicture:
        ...
        processList = []Processor{
            &previewGenerator{
                MaxWidth: DefaultThumbnailSizes[ThumbnailPreview], Uploader: storedFileInfo.Metadata.Uploader,
                Filename: storedFileInfo.Name, MimeType: storedFileInfo.MimeType, ThumbName: ThumbnailPreview, MetaData: metaData,
                Lock: metaDataLock, WaitGroup: wgMetaData,
            },
            &thumbGenerator{
                MaxDimension: DefaultThumbnailSizes[Thumbnail32], Uploader: storedFileInfo.Metadata.Uploader, Filename: storedFileInfo.Name,
                MimeType: storedFileInfo.MimeType, ThumbName: Thumbnail32, MetaData: metaData, Lock: metaDataLock, WaitGroup: wgMetaData,
            },
            &thumbGenerator{
                MaxDimension: DefaultThumbnailSizes[Thumbnail64], Uploader: storedFileInfo.Metadata.Uploader, Filename: storedFileInfo.Name,
                MimeType: storedFileInfo.MimeType, ThumbName: Thumbnail64, MetaData: metaData, Lock: metaDataLock, WaitGroup: wgMetaData,
            },
            &thumbGenerator{
                MaxDimension: DefaultThumbnailSizes[Thumbnail128], Uploader: storedFileInfo.Metadata.Uploader,
                Filename: storedFileInfo.Name, MimeType: storedFileInfo.MimeType, ThumbName: Thumbnail128, MetaData: metaData,
                Lock: metaDataLock, WaitGroup: wgMetaData,
            },
        }
