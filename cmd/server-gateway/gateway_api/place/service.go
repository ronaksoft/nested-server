...
func NewPlaceService(worker *api.Worker) *PlaceService {
	...
	s.serviceCommands = api.ServiceCommands{
		...
		CMD_GET_BLOCKED_ADDRESSES: {api.AUTH_LEVEL_USER, s.getBlockedAddresses},
		...
		CMD_ADD_TO_BLACKLIST:      {api.AUTH_LEVEL_USER, s.addToBlackList},
		CMD_REMOVE_FROM_BLACKLIST: {api.AUTH_LEVEL_USER, s.removeFromBlacklist},
	}
