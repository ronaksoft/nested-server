...
import (
	...
	"git.ronaksoftware.com/nested/server/cmd/server-gateway/gateway_api/account"
	"git.ronaksoftware.com/nested/server/cmd/server-gateway/gateway_api/admin"
	"git.ronaksoftware.com/nested/server/cmd/server-gateway/gateway_api/app"
	"git.ronaksoftware.com/nested/server/cmd/server-gateway/gateway_api/auth"
	"git.ronaksoftware.com/nested/server/cmd/server-gateway/gateway_api/client"
	"git.ronaksoftware.com/nested/server/cmd/server-gateway/gateway_api/contact"
	"git.ronaksoftware.com/nested/server/cmd/server-gateway/gateway_api/file"
	"git.ronaksoftware.com/nested/server/cmd/server-gateway/gateway_api/hook"
	"git.ronaksoftware.com/nested/server/cmd/server-gateway/gateway_api/label"
	"git.ronaksoftware.com/nested/server/cmd/server-gateway/gateway_api/notification"
	"git.ronaksoftware.com/nested/server/cmd/server-gateway/gateway_api/place"
	"git.ronaksoftware.com/nested/server/cmd/server-gateway/gateway_api/post"
	"git.ronaksoftware.com/nested/server/cmd/server-gateway/gateway_api/report"
	"git.ronaksoftware.com/nested/server/cmd/server-gateway/gateway_api/search"
	"git.ronaksoftware.com/nested/server/cmd/server-gateway/gateway_api/session"
	"git.ronaksoftware.com/nested/server/cmd/server-gateway/gateway_api/system"
	"git.ronaksoftware.com/nested/server/cmd/server-gateway/gateway_api/task"
	"git.ronaksoftware.com/nested/server/cmd/server-gateway/gateway_file"
