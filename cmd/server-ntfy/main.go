...
import (
	...
	"git.ronaksoft.com/nested/server/cmd/server-ntfy/v1"
...
func main() {
	...
	if rateLimiter, err := tools.NewSimpleRateLimiter(10*time.Second, _Config.GetInt("JOB_WORKERS_COUNT")); err != nil {
		log.Println(err.Error())
	} else {
